...
public class fileController {
    ...
    public String upload(MultipartFile file) {
        ...
        String filePath = "/app/src/main/resources/subidaArchivos/";
    ...
    public void download(HttpServletResponse response) throws Exception {
        ...
        switch (MainController.flagFormatD) {
            case "txt":
                file = new File("/app/src/main/resources/descargaArchivos/clientes.txt");
                break;
            case "xml":
                file = new File("/app/src/main/resources/descargaArchivos/clientes.xml");
                break;
            case "json":
                file = new File("/app/src/main/resources/descargaArchivos/clientes.json");
                break;
            default:
